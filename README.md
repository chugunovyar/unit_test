...
```text
	...
	Создавать заявки на основании анкет (http://localhost:8000/api/partners_create_zayavka/).
    	...
    	начало и конец ротации заявки, минимальный, максимальный скорринговый бал,
    	наименование кредитной организации (credit_org), номер и серию паспорта лица
    	подающего заявку (credit_org) 
	#Отправка заявки в кредитную организацию происходит по 	
```
